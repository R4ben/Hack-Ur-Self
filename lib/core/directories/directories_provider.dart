...
import 'package:hack_ur_self/core/model/directories.dart';
...
class AppDirectories extends _$AppDirectories with InfraLogger {
  final _methodChannel =
      const MethodChannel('com.exemple.hack_ur_self_app/platform');
  @override
  Future<Directories> build() async {
    ...
    if (Platform.isIOS) {
      ...
      dirs = (
        ...
        workingDir: Directory(paths?['workingDir']! as String),
